...
const Cart = () => {
  const { items, totalItems, totalPrice, removeItem, addItem, updateQuantity, observations, setObservations } = useCart();
            ...
            <div className="flex-1 overflow-y-auto py-4">
              {items.length === 0 ? (
                ...
                <div className="space-y-4">
                  {items.map(item => (
                    <div key={item.product.id} className="bg-secondary/50 rounded-lg p-4">
